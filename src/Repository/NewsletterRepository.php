...
class NewsletterRepository extends ServiceEntityRepository
{
    ...
    /**
     * @return Newsletter[] Returns an array of User objects
     */
    public function findAllActiveContacts(): array
    {
        return $this->createQueryBuilder('n')
            ->select("n.email as Email, n.user_name as Name, 'false' as IsExcludedFromCampaigns, 'object' as Properties")
