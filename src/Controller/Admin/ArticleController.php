...
class ArticleController extends AbstractController
{
    ...
    public function detailAction()
    {
        ...
        $user = $this->em
            ->getRepository(wp_users::class)
            ->findOneBy(['id' => $annonce->getPostAuthor()]);
        $usermeta = $this->em
            ->getRepository(WpUsermeta::class)
            ->findBy(['userId' => $user->getId()]);

        return $this->render('admin/detail_annonce.html.twig', [
            'annonce' => $annonce,
            'img' => $img,
            'user' => $user,
            'postmeta' => $postmeta,
    ...
    /**
     * @Route("/{_locale}/admin/article/upload", name="upload")
     */
