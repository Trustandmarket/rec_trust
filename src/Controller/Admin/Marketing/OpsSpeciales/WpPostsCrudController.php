...
namespace App\Controller\Admin\Marketing\OpsSpeciales;
...
class WpPostsCrudController extends AbstractCrudController
{
    ...
    {
        return $this->render('admin/Marketing/OpsSpeciales/all_ops_speciales.html.twig', [
            'ops' => $this->service_manager->getAllSpecialOps(),
    ...
    {
        $ops = $this->service_manager->getOneSpecialOps($context->getRequest()->query->get('entityId'));
        return $this->render('admin/Marketing/OpsSpeciales/edit_ops_speciales.html.twig', [
    ...
    {
        return $this->render('admin/Marketing/OpsSpeciales/create_ops_speciales.html.twig', [
