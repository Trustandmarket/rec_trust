...
class __TwigTemplate_7b6b5dabe99601345a710a5159675568 extends Template
{
...
($context["annoncesPublieesCount"] ?? null), "tag" => "publish"]), "html", null, true);
        yield "\" tabindex=\"-1\">";
...
\t\t\t";
        // line 25
        if (((($context["pages_publish"] ?? null) - ($context["noPage"] ?? null)) > 1)) {
            // line 26
            yield "\t\t\t\t<li class=\"page-item\">
\t\t\t\t\t<a class=\"page-link\" href=\"\">...<span class=\"sr-only\"></span>
\t\t\t\t\t</a>
...
\t\t";
        ...
        // line 32
        yield "\t\t";
        if (((($context["pages_publish"] ?? null) - ($context["noPage"] ?? null)) > 0)) {
            // line 33
            yield "\t\t\t<li class=\"page-item\">
\t\t\t\t<a class=\"page-link\" href=\"";
            // line 34
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("profile_listeAnnoncesPagine", ["noPage" => ($context["pages_publish"] ?? null), "nombreDeLignes" =>             // line 35
($context["annoncesPublieesCount"] ?? null), "tag" => "publish"]), "html", null, true);
            yield "\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["pages_publish"] ?? null), "html", null, true);
            yield "<span class=\"sr-only\"></span>
\t\t\t\t</a>
\t\t\t</li>
\t\t";
        ...
        // line 39
        yield "\t\t<li class=\"page-item ";
        if ((($context["noPage"] ?? null) == ($context["pages_publish"] ?? null))) {
            yield "disabled";
        }
        yield "\">
\t\t\t<a class=\"page-link\" href=\"";
...
\t</ul>
    ...
    {
        return new Source("", "profile/partials/pagination_bloc_annonces_publiees.html.twig", "/var/www/vhosts/trustandmarket.com/httpdocs/templates/profile/partials/pagination_bloc_annonces_publiees.html.twig");
    }
}
