...
/* profile/partials/pagination_bloc_reservations_terminees.html.twig */
class __TwigTemplate_873af73bb593ad0bd23ef1af99b81d5f extends Template
{
...
($context["reservationsTermineesCount"] ?? null), "tag" => "wc-completed"]), "html", null, true);
        yield "\" tabindex=\"-1\">";
...
\t\t\t";
        // line 25
        if (((($context["pages_reservations_completed"] ?? null) - ($context["noPage"] ?? null)) > 1)) {
            // line 26
            yield "\t\t\t\t<li class=\"page-item\">
\t\t\t\t\t<a class=\"page-link\" href=\"\">...<span class=\"sr-only\"></span>
\t\t\t\t\t</a>
...
\t\t";
        ...
        // line 32
        yield "\t\t";
        if (((($context["pages_reservations_completed"] ?? null) - ($context["noPage"] ?? null)) > 0)) {
            // line 33
            yield "\t\t\t<li class=\"page-item\">
\t\t\t\t<a class=\"page-link\" href=\"";
            // line 34
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("profile_listeAnnoncesPagine", ["noPage" => ($context["pages_reservations_completed"] ?? null), "nombreDeLignes" =>             // line 35
($context["reservationsTermineesCount"] ?? null), "tag" => "wc-completed"]), "html", null, true);
            yield "\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["pages_reservations_completed"] ?? null), "html", null, true);
            yield "<span class=\"sr-only\"></span>
\t\t\t\t</a>
\t\t\t</li>
\t\t";
        ...
        // line 39
        yield "\t\t<li class=\"page-item ";
        if ((($context["noPage"] ?? null) == ($context["pages_reservations_completed"] ?? null))) {
            yield "disabled";
        }
        yield "\">
\t\t\t<a class=\"page-link\" href=\"";
...
\t</ul>
    ...
    {
        return "profile/partials/pagination_bloc_reservations_terminees.html.twig";
    }
    ...
    {
        return new Source("", "profile/partials/pagination_bloc_reservations_terminees.html.twig", "/var/www/vhosts/trustandmarket.com/httpdocs/templates/profile/partials/pagination_bloc_reservations_terminees.html.twig");
    }
}
