...
class __TwigTemplate_f1a6c1751804bf7aef1615f3bbebe5c3 extends Template
{
...
($context["annoncesModerationCount"] ?? null), "tag" => "moderation"]), "html", null, true);
        yield "\" tabindex=\"-1\">";
...
\t\t\t";
        // line 25
        if (((($context["pages_moderation"] ?? null) - ($context["noPage"] ?? null)) > 1)) {
            // line 26
            yield "\t\t\t\t<li class=\"page-item\">
\t\t\t\t\t<a class=\"page-link\" href=\"\">...<span class=\"sr-only\"></span>
\t\t\t\t\t</a>
...
\t\t";
        ...
        // line 32
        yield "\t\t";
        if (((($context["pages_moderation"] ?? null) - ($context["noPage"] ?? null)) > 0)) {
            // line 33
            yield "\t\t\t<li class=\"page-item\">
\t\t\t\t<a class=\"page-link\" href=\"";
            // line 34
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("profile_listeAnnoncesPagine", ["noPage" => ($context["pages_moderation"] ?? null), "nombreDeLignes" =>             // line 35
($context["annoncesModerationCount"] ?? null), "tag" => "moderation"]), "html", null, true);
            yield "\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["pages_moderation"] ?? null), "html", null, true);
            yield "<span class=\"sr-only\"></span>
\t\t\t\t</a>
\t\t\t</li>
\t\t";
        ...
        // line 39
        yield "\t\t<li class=\"page-item ";
        if ((($context["noPage"] ?? null) == ($context["pages_moderation"] ?? null))) {
            yield "disabled";
        }
        yield "\">
\t\t\t<a class=\"page-link\" href=\"";
...
\t</ul>
    ...
    {
        return new Source("", "profile/partials/pagination_bloc_annonces_moderation.html.twig", "/var/www/vhosts/trustandmarket.com/httpdocs/templates/profile/partials/pagination_bloc_annonces_moderation.html.twig");
    }
}
