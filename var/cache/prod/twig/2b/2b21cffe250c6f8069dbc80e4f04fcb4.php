...
/* marketing/details.html.twig */
class __TwigTemplate_9c8f108489daf3309c10da3ba9e50529 extends Template
{
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("generalLayout.html.twig", "marketing/details.html.twig", 1);
...
<link rel=\"canonical\" href=\"";
        // line 7
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\HttpFoundationExtension']->generateAbsoluteUrl($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("marketing_details_ops_speciales", ["slug" => CoreExtension::getAttribute($this->env, $this->source, ($context["ops"] ?? null), "slug", [], "any", false, false, false, 7)])), "html", null, true);
        yield "\">
<link rel=\"shortlink\" href=\"";
        // line 8
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\HttpFoundationExtension']->generateAbsoluteUrl($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("marketing_details_ops_speciales", ["slug" => CoreExtension::getAttribute($this->env, $this->source, ($context["ops"] ?? null), "slug", [], "any", false, false, false, 8)])), "html", null, true);
        yield "\">
...
<meta property=\"og:url\" content=\"";
        // line 14
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\HttpFoundationExtension']->generateAbsoluteUrl($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("marketing_details_ops_speciales", ["slug" => CoreExtension::getAttribute($this->env, $this->source, ($context["ops"] ?? null), "slug", [], "any", false, false, false, 14)])), "html", null, true);
        yield "\">
...
\t\t\"url\": \"";
        // line 49
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\HttpFoundationExtension']->generateAbsoluteUrl($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("marketing_details_ops_speciales", ["slug" => CoreExtension::getAttribute($this->env, $this->source, ($context["ops"] ?? null), "slug", [], "any", false, false, false, 49)])), "html", null, true);
        yield "\",
\t\t\"mainEntityOfPage\": {
\t\t\t\"@type\": \"WebPage\",
\t\t\t\"@id\": \"";
        // line 52
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\HttpFoundationExtension']->generateAbsoluteUrl($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("marketing_details_ops_speciales", ["slug" => CoreExtension::getAttribute($this->env, $this->source, ($context["ops"] ?? null), "slug", [], "any", false, false, false, 52)])), "html", null, true);
        yield "\"
\t\t},
\t\t\"datePublished\": \"";
        // line 54
...
";
    ...
    public function block_title(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        yield "Trust &amp; Market | ";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("titre", [], "marketing"), "html", null, true);
        yield " | ";
...
\t\t<h3 hidden class=\"h3-responsive grand-titre\">";
        // line 289
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["ops"] ?? null), "titre", [], "any", false, false, false, 289), "html", null, true);
        yield "</h3>
\t\t<p class=\"detail_marketing\">
\t\t\t";
        // line 291
        yield CoreExtension::getAttribute($this->env, $this->source, ($context["ops"] ?? null), "chapeau", [], "any", false, false, false, 291);
        yield "
\t\t</p>
\t\t<section>
...
\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 297
            yield "\t\t\t\t\t\t<li class=\"dot ";
            if ((CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 297) == 1)) {
                yield "active-dot";
            }
            yield "\">•</li>
\t\t\t\t\t";
...
\t\t\t";
        ...
        yield "\t\t\t";
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["ops"] ?? null), "articles", [], "any", false, false, false, 302));
        $context['loop'] = [
          'parent' => $context['_parent'],
          'index0' => 0,
          'index'  => 1,
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            ...
            if ((($context["x"] ?? null) == 1)) {
                ...
                if ((CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, false, 304) == 1)) {
                    yield "active-slide";
                }
                yield "\">";
            }
...
\t\t\t\t\t\tstyle=\"background-image: url(";
            // line 307
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "guid", [], "any", false, false, false, 307), "html", null, true);
            yield ");\" title=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "postTitle", [], "any", false, false, false, 307), "html", null, true);
            yield "\"
\t\t\t\t\t\tattr-src=\"";
            // line 308
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "guid", [], "any", false, false, false, 308), "html", null, true);
            yield "\" 
\t\t\t\t\t\tdata-lcl-txt=\"<a class='buy_article'
\t\t\t\t\t\t data-email='serviceclients@kbr-global.com'
\t\t\t\t\t\t data-image='";
            // line 311
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "guid", [], "any", false, false, false, 311), "html", null, true);
            yield "'
\t\t\t\t\t\t data-price='";
            // line 312
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "toPing", [], "any", false, false, false, 312), "html", null, true);
            yield "'
\t\t\t\t\t\t data-id='";
            // line 313
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, false, 313), "html", null, true);
            yield "'
\t\t\t\t\t\t data-article-id='";
            // line 314
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["ops"] ?? null), "id", [], "any", false, false, false, 314), "html", null, true);
            yield "'
\t\t\t\t\t\t data-author-id='";
            // line 315
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["ops"] ?? null), "post_author", [], "any", false, false, false, 315), "html", null, true);
            yield "'
\t\t\t\t\t\t data-livraison='";
            // line 316
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "pinged", [], "any", false, false, false, 316), "html", null, true);
            yield "'
\t\t\t\t\t\t data-title='";
            // line 317
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "postTitle", [], "any", false, false, false, 317), "html", null, true);
            yield "'
\t\t\t\t\t\t data-ops-title='";
            // line 318
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["ops"] ?? null), "titre", [], "any", false, false, false, 318), "html", null, true);
            yield "'
\t\t\t\t\t\t data-slug='";
            // line 319
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "postName", [], "any", false, false, false, 319), "html", null, true);
            yield "'
\t\t\t\t\t\t href='#'>Acheter (";
            // line 320
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "toPing", [], "any", false, false, false, 320), "html", null, true);
            yield " €)</a>\"
\t\t\t\t\t\tdata-lcl-author=\"Trust&Market\"
\t\t\t\t\t\tdata-lcl-thumb=\"";
            // line 322
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "guid", [], "any", false, false, false, 322), "html", null, true);
            yield "\">
\t\t\t\t\t\t<p class=\"left-align-text\">
\t\t\t\t\t\t\t";
            // line 324
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "toPing", [], "any", false, false, false, 324), "html", null, true);
            yield " €
\t\t\t\t\t\t</p>
...
\t\t\t";
        // line 338
        yield CoreExtension::getAttribute($this->env, $this->source, ($context["ops"] ?? null), "description", [], "any", false, false, false, 338);
        yield "
\t\t</p>
\t\t<div class=\"row\">
\t\t";
        // line 341
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["ops"] ?? null), "categorie", [], "any", false, false, false, 341));
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 342
            yield "\t\t\t<a target=\"_blank\" href=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("annonces_listeAnnonces", ["type_prestation" => CoreExtension::getAttribute($this->env, $this->source, $context["item"], "slug", [], "any", false, false, false, 342), "services_proposes" => "", "code_postal_ville" => ""]), "html", null, true);
            yield "\" class=\"col-md-3 category_annonce_ahref\">
\t\t\t\t<div class=\"category_annonce col-md-12\">
\t\t\t\t\t";
            // line 344
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["item"], "name", [], "any", false, false, false, 344), "html", null, true);
            yield "
\t\t\t\t</div>
\t\t\t</a>
\t\t";
...
\t\tvar url1 = \"";
        ...
        yield "\" + '?id=' + \$(this).attr(\"data-id\") +'&id_article='
...
\t\t\t\$('#panier').html(parseInt('";
        // line 435
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 435), "get", ["taille"], "method", false, false, false, 435), "html", null, true);
        yield "') + 1);
\t\t\t\tlcl_close();
\t\t\t},
...
";
    ...
    {
        return "marketing/details.html.twig";
    }
    ...
    {
        return array (  819 => 435,  799 => 418,  750 => 372,  745 => 370,  740 => 368,  736 => 367,  730 => 364,  725 => 362,  721 => 361,  714 => 360,  706 => 356,  699 => 355,  690 => 348,  680 => 344,  674 => 342,  670 => 341,  664 => 338,  660 => 336,  646 => 335,  641 => 333,  638 => 332,  636 => 331,  626 => 324,  621 => 322,  616 => 320,  612 => 319,  608 => 318,  604 => 317,  600 => 316,  596 => 315,  592 => 314,  588 => 313,  584 => 312,  580 => 311,  574 => 308,  568 => 307,  564 => 305,  555 => 304,  552 => 303,  534 => 302,  532 => 301,  528 => 299,  509 => 297,  492 => 296,  484 => 291,  479 => 289,  473 => 285,  466 => 284,  449 => 270,  442 => 269,  434 => 265,  427 => 264,  245 => 85,  239 => 82,  235 => 81,  230 => 79,  221 => 73,  214 => 72,  200 => 70,  183 => 57,  179 => 56,  175 => 55,  171 => 54,  166 => 52,  160 => 49,  154 => 46,  139 => 34,  134 => 32,  127 => 27,  123 => 25,  119 => 24,  115 => 23,  111 => 22,  106 => 19,  99 => 14,  94 => 12,  89 => 10,  85 => 9,  81 => 8,  77 => 7,  73 => 6,  69 => 5,  65 => 4,  58 => 3,  47 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "marketing/details.html.twig", "/var/www/vhosts/trustandmarket.com/httpdocs/templates/marketing/details.html.twig");
    }
}
