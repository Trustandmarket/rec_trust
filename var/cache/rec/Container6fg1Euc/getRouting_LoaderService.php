 ...
 */
class getRouting_LoaderService extends App_KernelRecDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\Routing\AnnotatedRouteControllerLoader(($container->privates['annotations.cached_reader'] ?? $container->getAnnotations_CachedReaderService()), 'rec');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($b, 'rec'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($b, 'rec'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($b, 'rec'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($b, 'rec'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($b, 'rec'));
