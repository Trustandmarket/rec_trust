 ...
 */
class getDebug_ArgumentResolver_ServiceService extends App_KernelRecDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['.service_locator.4dwDxVK'] ?? $container->load('get_ServiceLocator_4dwDxVKService'));
