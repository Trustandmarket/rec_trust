...
class __TwigTemplate_8603af529dc2e2e1c621942f6f60c2d0 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "header-new-design.html.twig"));
...
<nav class=\"navbar fixed-top navbar-expand-lg navbar-dark scrolling-navbar pr-5 pl-5\"
    ...
    <div style=\"display: flex;\" class=\"logoButtonHeader\">
        ...
        // line 338
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 338, $this->source); })()), "request", [], "any", false, false, false, 338), "getLocale", [], "method", false, false, false, 338), "html", null, true);
        yield "\">
            <img src=\"";
        // line 339
    ...
    {
        return array (  400 => 344,  398 => 343,  395 => 342,  393 => 341,  388 => 339,  384 => 338,  45 => 1,);
    }
...
<nav class=\"navbar fixed-top navbar-expand-lg navbar-dark scrolling-navbar pr-5 pl-5\"
    ...
    <div style=\"display: flex;\" class=\"logoButtonHeader\">
        <a class=\"navbar-brand\" href=\"/{{ app.request.getLocale() }}\">
            <img src=\"{{prerender(asset('assets/img/logo_tm.svg'))}}\" width=\"40\" height=\"40\" alt=\"logo\">
        </a>
        {% include(\"headerMenuSite.html.twig\") %}
    </div>
    {% include(\"headerMenuSite.html.twig\") %}
    <!-- Collapsible content -->
</nav>", "header-new-design.html.twig", "/var/www/vhosts/trustandmarket.com/rec.trustandmarket.com/templates/header-new-design.html.twig");
    }
}
