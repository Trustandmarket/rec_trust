...
class __TwigTemplate_b88fdd943aac91ea9eccc972b769b58b extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "admin/Marketing/PromoComs/details_promo_com.html.twig"));
...
\t\t\t\t\t\t\t\t\t\t<div class=\"container border border-info rounded p-2\">";
        // line 128
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["ops"]) || array_key_exists("ops", $context) ? $context["ops"] : (function () { throw new RuntimeError('Variable "ops" does not exist.', 128, $this->source); })()), "meta_description", [], "any", false, false, false, 128), "html", null, true);
        yield "</div>
\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t\t<button class=\"container border border-info rounded p-2\" id=\"url\" onclick=\"copyToClipboard()\">";
        // line 133
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\HttpFoundationExtension']->generateAbsoluteUrl($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("marketing_details_promo_com", ["slug" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["ops"]) || array_key_exists("ops", $context) ? $context["ops"] : (function () { throw new RuntimeError('Variable "ops" does not exist.', 133, $this->source); })()), "slug", [], "any", false, false, false, 133)])), "html", null, true);
        yield "</button>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t
...
\t\t\t\t\t\t\t\t\t";
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["ops"]) || array_key_exists("ops", $context) ? $context["ops"] : (function () { throw new RuntimeError('Variable "ops" does not exist.', 139, $this->source); })()), "articles", [], "any", false, false, false, 139));
...
\t\t\t\t\t\t\t\t\t\t<div class=\"container border border-info rounded p-3\">";
        // line 153
        yield CoreExtension::getAttribute($this->env, $this->source, (isset($context["ops"]) || array_key_exists("ops", $context) ? $context["ops"] : (function () { throw new RuntimeError('Variable "ops" does not exist.', 153, $this->source); })()), "description", [], "any", false, false, false, 153);
        yield "</div>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t<div class=\"col-md-6 form-group\">
...
\t\t\t\t\t\t\t\t\t\t<div class=\"container border border-info rounded p-3\" id=\"chapeau\">";
        // line 157
        yield CoreExtension::getAttribute($this->env, $this->source, (isset($context["ops"]) || array_key_exists("ops", $context) ? $context["ops"] : (function () { throw new RuntimeError('Variable "ops" does not exist.', 157, $this->source); })()), "chapeau", [], "any", false, false, false, 157);
        yield "</div>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t<div class=\"col-md-6\">
...
\t\t\t\t\t\t\t\t\t\t\t<input disabled class=\"form-check-input\" type=\"checkbox\" name=\"cat_afficher\" ";
            // line 164
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["ops"]) || array_key_exists("ops", $context) ? $context["ops"] : (function () { throw new RuntimeError('Variable "ops" does not exist.', 164, $this->source); })()), "categorie", [], "any", false, false, false, 164));
...
";
    ...
    {
        return array (  414 => 199,  410 => 198,  406 => 197,  400 => 194,  396 => 193,  392 => 192,  389 => 191,  383 => 187,  377 => 184,  367 => 183,  351 => 173,  341 => 169,  333 => 167,  327 => 166,  322 => 165,  318 => 164,  315 => 163,  311 => 162,  303 => 157,  296 => 153,  289 => 148,  279 => 144,  275 => 143,  268 => 141,  263 => 140,  259 => 139,  250 => 133,  242 => 128,  234 => 123,  130 => 22,  125 => 20,  121 => 19,  117 => 18,  112 => 16,  108 => 15,  104 => 14,  100 => 13,  96 => 12,  91 => 11,  88 => 7,  78 => 6,  69 => 3,  59 => 2,  42 => 1,);
    }
...
\t\t\t\t\t\t\t\t\t<div class=\"col-md-6 form-group\">
\t\t\t\t\t\t\t\t\t\t<label class=\"col-md-12 label-perso\">URL</label>
\t\t\t\t\t\t\t\t\t\t<button class=\"container border border-info rounded p-2\" id=\"url\" onclick=\"copyToClipboard()\">{{absolute_url(path('marketing_details_promo_com',{slug: ops.slug}))}}</button>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t<div class=\"row\">
...
", "admin/Marketing/PromoComs/details_promo_com.html.twig", "/var/www/vhosts/trustandmarket.com/rec.trustandmarket.com/templates/admin/Marketing/PromoComs/details_promo_com.html.twig");
    }
}
