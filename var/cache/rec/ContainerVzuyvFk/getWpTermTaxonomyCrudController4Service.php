 ...
 */
class getWpTermTaxonomyCrudController4Service extends App_KernelRecDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Controller/Admin/ToutesCategories/WpTermTaxonomyCrudController.php';
